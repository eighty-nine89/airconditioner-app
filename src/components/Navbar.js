...
import { FaFacebook, FaInstagram, FaLinkedin, FaStore, FaTiktok } from "react-icons/fa6";
...
const Navbar = () => {
    return (
        <div className='Navbar cursor-pointer'>
            ...
            {/* Navbar */}
            <div className='w-full h-20 pt-10 px-5 bg-white md:px-64 flex flex-row text-center justify-between relative'>
                {/* Logo */}
                ...
                <div className='flex flex-row gap-5 lg:my-auto whitespace-nowrap'>
                    <h4 className="text-sm items-baseline font-light text-gray hover:text-black">Home</h4>
                    <h4 className="text-sm font-light text-gray hover:text-black">Products</h4>
                    <h4 className="text-sm font-light text-gray hover:text-black">Services</h4>
                    <h4 className="text-sm font-light text-gray hover:text-black">About Us</h4>
                    <h4 className="text-sm font-light text-gray hover:text-black">Contact Us</h4>
                    {/* search input */}
                    <div className="lg:my-auto flex flex-row gap-5">
                        <input type='search' placeholder="Search here..." className='border-2 border-x-0 border-t-0 border-y-3 outline-none border-gray focus:border-black px-2 font-light text-sm' /> 
                    </div>
                </div>
            </div>
        </div>
